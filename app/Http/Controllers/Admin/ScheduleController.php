...
class ScheduleController extends Controller
{
    ...
    public function create()
    {
        ...
        $lecturers = Lecturer::all()->pluck('name', 'id')->prepend(trans('global.pleaseSelect'), '');
    ...
    public function edit(Schedule $schedule)
    {
        ...
        $schedule->load('lecturer');

        return view('admin.schedules.edit', compact('lecturers', 'schedule'));
    }
